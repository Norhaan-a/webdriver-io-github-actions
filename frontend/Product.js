class Product {
  ...
  addEventListeners() {
    ...
    listen('submit', '.productInList form, .product form', event => {
      // all web browser wants to reload the page on a form submit for historical reasons -
      // we don't want that so we ask the browser to not perform it default action.
